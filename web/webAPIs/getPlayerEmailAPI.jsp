...
<%@page language="java" import="model.email.*" %>  
<%@page language="java" import="view.EmailView" %> 
...
<%
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        System.out.println("*** Ready to call allEmailAPI");
        list = EmailView.allEmailAPI(dbc);  
    } 
