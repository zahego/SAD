...
<%@page language="java" import="model.className.*" %>  
<%@page language="java" import="view.ClassNameView" %> 
...
<%
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        System.out.println("*** Ready to call allClassNameAPI");
        list = ClassNameView.allClassNameAPI(dbc);  
    } 
