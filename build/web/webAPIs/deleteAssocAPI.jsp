...
<%
    ...
    StringData2 sd = new StringData2(); // we really only need the errorMsg property of object sd... 

    DbConn dbc = new DbConn();
    sd.errorMsg = dbc.getErr(); // returns "" if connection is good, else db error msg.
    
    String idToDelete = request.getParameter("deleteAssocId");

    if (sd.errorMsg.length() == 0) { // if got good DB connection,

        System.out.println("*** Ready to call delete method");
        sd.errorMsg = DbMods2.delete(idToDelete, dbc); 
    }
